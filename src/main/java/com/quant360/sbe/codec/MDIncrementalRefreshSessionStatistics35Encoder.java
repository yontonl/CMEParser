...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshSessionStatistics35Encoder.NoMDEntriesEncoder.class})
/**
 * MDIncrementalRefreshSessionStatistics
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshSessionStatistics35Encoder implements MessageEncoderFlyweight
{
