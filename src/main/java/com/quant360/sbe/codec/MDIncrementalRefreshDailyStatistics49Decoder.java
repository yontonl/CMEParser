...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshDailyStatistics49Decoder.NoMDEntriesDecoder.class})
/**
 * MDIncrementalRefreshDailyStatistics
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshDailyStatistics49Decoder implements MessageDecoderFlyweight
{
    ...
    public MDIncrementalRefreshDailyStatistics49Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MDIncrementalRefreshDailyStatistics49Decoder sbeRewind()
    {
    ...
    public MDIncrementalRefreshDailyStatistics49Decoder sbeSkip()
    {
        sbeRewind();
