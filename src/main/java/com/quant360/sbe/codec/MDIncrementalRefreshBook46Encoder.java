...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshBook46Encoder.NoMDEntriesEncoder.class,
    MDIncrementalRefreshBook46Encoder.NoOrderIDEntriesEncoder.class})
/**
 * MDIncrementalRefreshBook
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshBook46Encoder implements MessageEncoderFlyweight
{
