...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDInstrumentDefinitionOption55Encoder.NoEventsEncoder.class,
    MDInstrumentDefinitionOption55Encoder.NoMDFeedTypesEncoder.class,
    MDInstrumentDefinitionOption55Encoder.NoInstAttribEncoder.class,
    MDInstrumentDefinitionOption55Encoder.NoLotTypeRulesEncoder.class,
    MDInstrumentDefinitionOption55Encoder.NoUnderlyingsEncoder.class,
    MDInstrumentDefinitionOption55Encoder.NoRelatedInstrumentsEncoder.class})
/**
 * MDInstrumentDefinitionOption
 */
@SuppressWarnings("all")
public final class MDInstrumentDefinitionOption55Encoder implements MessageEncoderFlyweight
{
    ...
    public MDInstrumentDefinitionOption55Encoder putSecurityExchange(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public MDInstrumentDefinitionOption55Encoder putCurrency(final byte value0, final byte value1, final byte value2)
    {
    ...
    public MDInstrumentDefinitionOption55Encoder putStrikeCurrency(final byte value0, final byte value1, final byte value2)
    {
    ...
    public MDInstrumentDefinitionOption55Encoder putSettlCurrency(final byte value0, final byte value1, final byte value2)
    {
