...
public final class AdminLogin15Decoder implements MessageDecoderFlyweight
{
    ...
    public AdminLogin15Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public AdminLogin15Decoder sbeRewind()
    {
    ...
    public AdminLogin15Decoder sbeSkip()
    {
        sbeRewind();
