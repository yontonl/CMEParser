...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshBook46Decoder.NoMDEntriesDecoder.class,
    MDIncrementalRefreshBook46Decoder.NoOrderIDEntriesDecoder.class})
/**
 * MDIncrementalRefreshBook
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshBook46Decoder implements MessageDecoderFlyweight
{
