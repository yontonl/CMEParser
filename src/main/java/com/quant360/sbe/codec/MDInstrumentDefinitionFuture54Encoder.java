...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDInstrumentDefinitionFuture54Encoder.NoEventsEncoder.class,
    MDInstrumentDefinitionFuture54Encoder.NoMDFeedTypesEncoder.class,
    MDInstrumentDefinitionFuture54Encoder.NoInstAttribEncoder.class,
    MDInstrumentDefinitionFuture54Encoder.NoLotTypeRulesEncoder.class})
/**
 * MDInstrumentDefinitionFuture
 */
@SuppressWarnings("all")
public final class MDInstrumentDefinitionFuture54Encoder implements MessageEncoderFlyweight
{
    ...
    public MDInstrumentDefinitionFuture54Encoder putSecurityExchange(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder putCurrency(final byte value0, final byte value1, final byte value2)
    {
    ...
    public MDInstrumentDefinitionFuture54Encoder putSettlCurrency(final byte value0, final byte value1, final byte value2)
    {
