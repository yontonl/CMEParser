...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDInstrumentDefinitionSpread56Decoder.NoEventsDecoder.class,
    MDInstrumentDefinitionSpread56Decoder.NoMDFeedTypesDecoder.class,
    MDInstrumentDefinitionSpread56Decoder.NoInstAttribDecoder.class,
    MDInstrumentDefinitionSpread56Decoder.NoLotTypeRulesDecoder.class,
    MDInstrumentDefinitionSpread56Decoder.NoLegsDecoder.class})
/**
 * MDInstrumentDefinitionSpread
 */
@SuppressWarnings("all")
public final class MDInstrumentDefinitionSpread56Decoder implements MessageDecoderFlyweight
{
    ...
    public MDInstrumentDefinitionSpread56Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MDInstrumentDefinitionSpread56Decoder sbeRewind()
    {
        ...
        implements Iterable<NoLegsDecoder>, java.util.Iterator<NoLegsDecoder>
    {
        ...
        public StringBuilder appendTo(final StringBuilder builder)
        {
            ...
            final PRICENULL9Decoder legPrice = legPrice();
            if (legPrice != null)
            {
    ...
    public String toString()
    {
        ...
        final MDInstrumentDefinitionSpread56Decoder decoder = new MDInstrumentDefinitionSpread56Decoder();
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final PRICENULL9Decoder priceRatio = priceRatio();
        if (priceRatio != null)
        {
    ...
    public MDInstrumentDefinitionSpread56Decoder sbeSkip()
    {
        sbeRewind();
