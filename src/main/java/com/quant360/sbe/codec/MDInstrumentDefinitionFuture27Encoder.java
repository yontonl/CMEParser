...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDInstrumentDefinitionFuture27Encoder.NoEventsEncoder.class,
    MDInstrumentDefinitionFuture27Encoder.NoMDFeedTypesEncoder.class,
    MDInstrumentDefinitionFuture27Encoder.NoInstAttribEncoder.class,
    MDInstrumentDefinitionFuture27Encoder.NoLotTypeRulesEncoder.class})
/**
 * MDInstrumentDefinitionFuture
 */
@SuppressWarnings("all")
public final class MDInstrumentDefinitionFuture27Encoder implements MessageEncoderFlyweight
{
