...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    SnapshotFullRefreshOrderBook44Decoder.NoMDEntriesDecoder.class})
/**
 * SnapshotFullRefreshOrderBook
 */
@SuppressWarnings("all")
public final class SnapshotFullRefreshOrderBook44Decoder implements MessageDecoderFlyweight
{
