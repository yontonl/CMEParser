...
public final class InstAttribValueDecoder implements Flyweight
{
    ...
    public long getRaw()
    {
        return (buffer.getInt(offset, java.nio.ByteOrder.LITTLE_ENDIAN) & 0xFFFF_FFFFL);
    }
    /**
     * 1=Electronic Match Eligible
     *
     * @return true if ElectronicMatchEligible set or false if not.
     */
     ...
     *
     * @return true if OrderCrossEligible set or false if not.
     */
     ...
     *
     * @return true if BlockTradeEligible set or false if not.
     */
     ...
     * 1=EFP Eligible
     *
     * @return true if EFPEligible set or false if not.
     */
     ...
     * 1=EBF Eligible
     *
     * @return true if EBFEligible set or false if not.
     */
     ...
     * 1=EFS Eligible
     *
     * @return true if EFSEligible set or false if not.
     */
     ...
     * 1=EFR Eligible
     *
     * @return true if EFREligible set or false if not.
     */
     ...
     * 1=OTC Eligible
     *
     * @return true if OTCEligible set or false if not.
     */
     ...
     *
     * @return true if iLinkIndicativeMassQuotingEligible set or false if not.
     */
     ...
     *
     * @return true if NegativeStrikeEligible set or false if not.
     */
     ...
     *
     * @return true if NegativePriceOutrightEligible set or false if not.
     */
     ...
     *
     * @return true if IsFractional set or false if not.
     */
     ...
     *
     * @return true if VolatilityQuotedOption set or false if not.
     */
     ...
     *
     * @return true if RFQCrossEligible set or false if not.
     */
     ...
     *
     * @return true if ZeroPriceOutrightEligible set or false if not.
     */
     ...
     *
     * @return true if DecayingProductEligibility set or false if not.
     */
     ...
     *
     * @return true if VariableProductEligibility set or false if not.
     */
     ...
     *
     * @return true if DailyProductEligibility set or false if not.
     */
     ...
     *
     * @return true if GTOrdersEligibility set or false if not.
     */
     ...
     *
     * @return true if ImpliedMatchingEligibility set or false if not.
     */
     ...
     *
     * @return true if TriangulationEligible set or false if not.
     */
     ...
     *
     * @return true if VariableCabEligible set or false if not.
     */
