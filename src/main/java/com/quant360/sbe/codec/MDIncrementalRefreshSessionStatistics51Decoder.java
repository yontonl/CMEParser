...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshSessionStatistics51Decoder.NoMDEntriesDecoder.class})
/**
 * MDIncrementalRefreshSessionStatistics
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshSessionStatistics51Decoder implements MessageDecoderFlyweight
{
