...
public final class SettlPriceTypeDecoder implements Flyweight
{
     ...
     *
     * @return true if FinalDaily set or false if not.
     */
     ...
     *
     * @return true if Actual set or false if not.
     */
     ...
     *
     * @return true if Rounded set or false if not.
     */
     ...
     *
     * @return true if Intraday set or false if not.
     */
     ...
     *
     * @return true if ReservedBits set or false if not.
     */
     ...
     *
     * @return true if NullValue set or false if not.
     */
