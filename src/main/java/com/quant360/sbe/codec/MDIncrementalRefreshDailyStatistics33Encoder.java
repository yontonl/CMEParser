...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshDailyStatistics33Encoder.NoMDEntriesEncoder.class})
/**
 * MDIncrementalRefreshDailyStatistics
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshDailyStatistics33Encoder implements MessageEncoderFlyweight
{
