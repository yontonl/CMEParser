...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshLimitsBanding34Decoder.NoMDEntriesDecoder.class})
/**
 * MDIncrementalRefreshLimitsBanding
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshLimitsBanding34Decoder implements MessageDecoderFlyweight
{
    ...
    public MDIncrementalRefreshLimitsBanding34Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MDIncrementalRefreshLimitsBanding34Decoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final MDIncrementalRefreshLimitsBanding34Decoder decoder = new MDIncrementalRefreshLimitsBanding34Decoder();
    ...
    public MDIncrementalRefreshLimitsBanding34Decoder sbeSkip()
    {
        sbeRewind();
