...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshSessionStatistics51Encoder.NoMDEntriesEncoder.class})
/**
 * MDIncrementalRefreshSessionStatistics
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshSessionStatistics51Encoder implements MessageEncoderFlyweight
{
