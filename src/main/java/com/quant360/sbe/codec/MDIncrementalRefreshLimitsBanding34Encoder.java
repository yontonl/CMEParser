...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshLimitsBanding34Encoder.NoMDEntriesEncoder.class})
/**
 * MDIncrementalRefreshLimitsBanding
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshLimitsBanding34Encoder implements MessageEncoderFlyweight
{
