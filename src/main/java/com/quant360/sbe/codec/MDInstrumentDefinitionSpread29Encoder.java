...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDInstrumentDefinitionSpread29Encoder.NoEventsEncoder.class,
    MDInstrumentDefinitionSpread29Encoder.NoMDFeedTypesEncoder.class,
    MDInstrumentDefinitionSpread29Encoder.NoInstAttribEncoder.class,
    MDInstrumentDefinitionSpread29Encoder.NoLotTypeRulesEncoder.class,
    MDInstrumentDefinitionSpread29Encoder.NoLegsEncoder.class})
/**
 * MDInstrumentDefinitionSpread
 */
@SuppressWarnings("all")
public final class MDInstrumentDefinitionSpread29Encoder implements MessageEncoderFlyweight
{
    ...
    public MDInstrumentDefinitionSpread29Encoder putSecurityExchange(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public MDInstrumentDefinitionSpread29Encoder putCurrency(final byte value0, final byte value1, final byte value2)
    {
