...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    SnapshotFullRefreshOrderBook53Decoder.NoMDEntriesDecoder.class})
/**
 * SnapshotFullRefreshOrderBook
 */
@SuppressWarnings("all")
public final class SnapshotFullRefreshOrderBook53Decoder implements MessageDecoderFlyweight
{
    ...
    public SnapshotFullRefreshOrderBook53Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public SnapshotFullRefreshOrderBook53Decoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final SnapshotFullRefreshOrderBook53Decoder decoder = new SnapshotFullRefreshOrderBook53Decoder();
    ...
    public SnapshotFullRefreshOrderBook53Decoder sbeSkip()
    {
        sbeRewind();
