...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    SnapshotFullRefreshOrderBook53Encoder.NoMDEntriesEncoder.class})
/**
 * SnapshotFullRefreshOrderBook
 */
@SuppressWarnings("all")
public final class SnapshotFullRefreshOrderBook53Encoder implements MessageEncoderFlyweight
{
