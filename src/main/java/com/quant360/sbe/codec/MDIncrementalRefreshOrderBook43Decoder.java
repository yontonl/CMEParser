...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshOrderBook43Decoder.NoMDEntriesDecoder.class})
/**
 * MDIncrementalRefreshOrderBook
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshOrderBook43Decoder implements MessageDecoderFlyweight
{
    ...
    public MDIncrementalRefreshOrderBook43Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MDIncrementalRefreshOrderBook43Decoder sbeRewind()
    {
    ...
    public MDIncrementalRefreshOrderBook43Decoder sbeSkip()
    {
        sbeRewind();
