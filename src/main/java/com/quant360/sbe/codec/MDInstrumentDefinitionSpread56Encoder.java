...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDInstrumentDefinitionSpread56Encoder.NoEventsEncoder.class,
    MDInstrumentDefinitionSpread56Encoder.NoMDFeedTypesEncoder.class,
    MDInstrumentDefinitionSpread56Encoder.NoInstAttribEncoder.class,
    MDInstrumentDefinitionSpread56Encoder.NoLotTypeRulesEncoder.class,
    MDInstrumentDefinitionSpread56Encoder.NoLegsEncoder.class})
/**
 * MDInstrumentDefinitionSpread
 */
@SuppressWarnings("all")
public final class MDInstrumentDefinitionSpread56Encoder implements MessageEncoderFlyweight
{
    ...
    public MDInstrumentDefinitionSpread56Encoder putSecurityExchange(final byte value0, final byte value1, final byte value2, final byte value3)
    {
    ...
    public MDInstrumentDefinitionSpread56Encoder putCurrency(final byte value0, final byte value1, final byte value2)
    {
    ...
    public MDInstrumentDefinitionSpread56Encoder putUnitOfMeasure(final byte[] src, final int srcOffset)
    {
        ...
        buffer.putBytes(offset + 120, src, srcOffset, length);
    ...
    public MDInstrumentDefinitionSpread56Encoder unitOfMeasure(final String src)
    {
        ...
        buffer.putStringWithoutLengthAscii(offset + 120, src);

        for (int start = srcLength; start < length; ++start)
        {
            buffer.putByte(offset + 120 + start, (byte)0);
        }
