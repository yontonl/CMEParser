...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshOrderBook47Encoder.NoMDEntriesEncoder.class})
/**
 * MDIncrementalRefreshOrderBook
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshOrderBook47Encoder implements MessageEncoderFlyweight
{
