...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDInstrumentDefinitionFuture27Decoder.NoEventsDecoder.class,
    MDInstrumentDefinitionFuture27Decoder.NoMDFeedTypesDecoder.class,
    MDInstrumentDefinitionFuture27Decoder.NoInstAttribDecoder.class,
    MDInstrumentDefinitionFuture27Decoder.NoLotTypeRulesDecoder.class})
/**
 * MDInstrumentDefinitionFuture
 */
@SuppressWarnings("all")
public final class MDInstrumentDefinitionFuture27Decoder implements MessageDecoderFlyweight
{
    ...
    public MDInstrumentDefinitionFuture27Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MDInstrumentDefinitionFuture27Decoder sbeRewind()
    {
    ...
    public MDInstrumentDefinitionFuture27Decoder sbeSkip()
    {
        sbeRewind();
