...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshTradeSummary42Encoder.NoMDEntriesEncoder.class,
    MDIncrementalRefreshTradeSummary42Encoder.NoOrderIDEntriesEncoder.class})
/**
 * MDIncrementalRefreshTradeSummary
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshTradeSummary42Encoder implements MessageEncoderFlyweight
{
