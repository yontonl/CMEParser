...
public final class SecurityStatus30Decoder implements MessageDecoderFlyweight
{
    ...
    public SecurityStatus30Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public SecurityStatus30Decoder sbeRewind()
    {
    ...
    {
        final byte[] dst = new byte[6];
        buffer.getBytes(offset + 14, dst, 0, 6);
    ...
    public short securityTradingStatusRaw()
    {
    ...
    public short securityTradingEventRaw()
    {
    ...
    public SecurityStatus30Decoder sbeSkip()
    {
        sbeRewind();
