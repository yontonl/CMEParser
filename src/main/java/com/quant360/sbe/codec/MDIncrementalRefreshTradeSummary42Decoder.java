...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshTradeSummary42Decoder.NoMDEntriesDecoder.class,
    MDIncrementalRefreshTradeSummary42Decoder.NoOrderIDEntriesDecoder.class})
/**
 * MDIncrementalRefreshTradeSummary
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshTradeSummary42Decoder implements MessageDecoderFlyweight
{
    ...
    public MDIncrementalRefreshTradeSummary42Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MDIncrementalRefreshTradeSummary42Decoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final MDIncrementalRefreshTradeSummary42Decoder decoder = new MDIncrementalRefreshTradeSummary42Decoder();
    ...
    public MDIncrementalRefreshTradeSummary42Decoder sbeSkip()
    {
        sbeRewind();
