...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDInstrumentDefinitionFuture54Decoder.NoEventsDecoder.class,
    MDInstrumentDefinitionFuture54Decoder.NoMDFeedTypesDecoder.class,
    MDInstrumentDefinitionFuture54Decoder.NoInstAttribDecoder.class,
    MDInstrumentDefinitionFuture54Decoder.NoLotTypeRulesDecoder.class})
/**
 * MDInstrumentDefinitionFuture
 */
@SuppressWarnings("all")
public final class MDInstrumentDefinitionFuture54Decoder implements MessageDecoderFlyweight
{
    ...
    public MDInstrumentDefinitionFuture54Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MDInstrumentDefinitionFuture54Decoder sbeRewind()
    {
    ...
    {
        final byte[] dst = new byte[3];
        buffer.getBytes(offset + 79, dst, 0, 3);
    ...
    public int getUnitOfMeasure(final byte[] dst, final int dstOffset)
    {
        ...
        buffer.getBytes(offset + 110, dst, dstOffset, length);
    ...
    public String unitOfMeasure()
    {
        ...
        buffer.getBytes(offset + 110, dst, 0, 30);
    ...
    public int getUnitOfMeasure(final Appendable value)
    {
        for (int i = 0; i < 30; ++i)
        {
            final int c = buffer.getByte(offset + 110 + i) & 0xFF;
            if (c == 0)
            {
                return i;
            }
    ...
    public String toString()
    {
        ...
        final MDInstrumentDefinitionFuture54Decoder decoder = new MDInstrumentDefinitionFuture54Decoder();
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final PRICE9Decoder minPriceIncrement = minPriceIncrement();
    ...
    public MDInstrumentDefinitionFuture54Decoder sbeSkip()
    {
        sbeRewind();
