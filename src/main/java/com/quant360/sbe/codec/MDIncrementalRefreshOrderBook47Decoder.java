...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshOrderBook47Decoder.NoMDEntriesDecoder.class})
/**
 * MDIncrementalRefreshOrderBook
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshOrderBook47Decoder implements MessageDecoderFlyweight
{
    ...
    public MDIncrementalRefreshOrderBook47Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MDIncrementalRefreshOrderBook47Decoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final MDIncrementalRefreshOrderBook47Decoder decoder = new MDIncrementalRefreshOrderBook47Decoder();
    ...
    public MDIncrementalRefreshOrderBook47Decoder sbeSkip()
    {
        sbeRewind();
