...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshBook32Decoder.NoMDEntriesDecoder.class,
    MDIncrementalRefreshBook32Decoder.NoOrderIDEntriesDecoder.class})
/**
 * MDIncrementalRefreshBook
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshBook32Decoder implements MessageDecoderFlyweight
{
    ...
    public MDIncrementalRefreshBook32Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MDIncrementalRefreshBook32Decoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final MDIncrementalRefreshBook32Decoder decoder = new MDIncrementalRefreshBook32Decoder();
    ...
    public MDIncrementalRefreshBook32Decoder sbeSkip()
    {
        sbeRewind();
