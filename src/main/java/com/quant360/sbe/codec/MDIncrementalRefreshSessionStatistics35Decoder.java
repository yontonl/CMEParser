...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshSessionStatistics35Decoder.NoMDEntriesDecoder.class})
/**
 * MDIncrementalRefreshSessionStatistics
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshSessionStatistics35Decoder implements MessageDecoderFlyweight
{
    ...
    public MDIncrementalRefreshSessionStatistics35Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MDIncrementalRefreshSessionStatistics35Decoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final MDIncrementalRefreshSessionStatistics35Decoder decoder = new MDIncrementalRefreshSessionStatistics35Decoder();
    ...
    public MDIncrementalRefreshSessionStatistics35Decoder sbeSkip()
    {
        sbeRewind();
