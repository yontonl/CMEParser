...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDInstrumentDefinitionOption55Decoder.NoEventsDecoder.class,
    MDInstrumentDefinitionOption55Decoder.NoMDFeedTypesDecoder.class,
    MDInstrumentDefinitionOption55Decoder.NoInstAttribDecoder.class,
    MDInstrumentDefinitionOption55Decoder.NoLotTypeRulesDecoder.class,
    MDInstrumentDefinitionOption55Decoder.NoUnderlyingsDecoder.class,
    MDInstrumentDefinitionOption55Decoder.NoRelatedInstrumentsDecoder.class})
/**
 * MDInstrumentDefinitionOption
 */
@SuppressWarnings("all")
public final class MDInstrumentDefinitionOption55Decoder implements MessageDecoderFlyweight
{
    ...
    public MDInstrumentDefinitionOption55Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public MDInstrumentDefinitionOption55Decoder sbeRewind()
    {
    ...
    public String toString()
    {
        ...
        final MDInstrumentDefinitionOption55Decoder decoder = new MDInstrumentDefinitionOption55Decoder();
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final PRICENULL9Decoder strikePrice = strikePrice();
        if (strikePrice != null)
        {
        ...
        final PRICENULL9Decoder minCabPrice = minCabPrice();
        if (minCabPrice != null)
        {
        ...
        final PRICENULL9Decoder minPriceIncrement = minPriceIncrement();
        ...
        final PRICENULL9Decoder minPriceIncrementAmount = minPriceIncrementAmount();
        ...
        final Decimal9Decoder displayFactor = displayFactor();
        ...
        final Decimal9NULLDecoder unitOfMeasureQty = unitOfMeasureQty();
        ...
        final PRICENULL9Decoder tradingReferencePrice = tradingReferencePrice();
    ...
    public MDInstrumentDefinitionOption55Decoder sbeSkip()
    {
        sbeRewind();
