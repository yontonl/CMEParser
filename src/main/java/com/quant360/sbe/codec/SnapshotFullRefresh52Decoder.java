...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    SnapshotFullRefresh52Decoder.NoMDEntriesDecoder.class})
/**
 * SnapshotFullRefresh
 */
@SuppressWarnings("all")
public final class SnapshotFullRefresh52Decoder implements MessageDecoderFlyweight
{
    ...
    public SnapshotFullRefresh52Decoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public SnapshotFullRefresh52Decoder sbeRewind()
    {
    ...
    public SnapshotFullRefresh52Decoder sbeSkip()
    {
        sbeRewind();
