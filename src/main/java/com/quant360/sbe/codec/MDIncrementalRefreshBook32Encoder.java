...
@uk.co.real_logic.sbe.codec.java.GroupOrder({
    MDIncrementalRefreshBook32Encoder.NoMDEntriesEncoder.class,
    MDIncrementalRefreshBook32Encoder.NoOrderIDEntriesEncoder.class})
/**
 * MDIncrementalRefreshBook
 */
@SuppressWarnings("all")
public final class MDIncrementalRefreshBook32Encoder implements MessageEncoderFlyweight
{
